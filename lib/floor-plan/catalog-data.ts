 ...
 * 中国代表性真实住宅户型数据集（50 套）
 *
 * 来源：docs/china-representative-floor-plans/standard-floorplans-50.ts
 * 说明：source 字段按既有 StandardFloorPlan schema 固定为 "template"；
 * 真实来源见独立 research-manifest.json。所有对象均为 raw StandardFloorPlan。
 */
...
export const FLOOR_PLAN_CATALOG_DATA: readonly StandardFloorPlan[] = [
  ...
  PLAN_CN_BJ_JINGXI_120,
  PLAN_CN_BJ_SHOUKAIJINMAO_120,
  PLAN_CN_SH_YUJINGHUATING_163,
  PLAN_CN_GZ_BINJIANGTIANDI_132,
  PLAN_CN_SZ_SHENTIEJINGCHENG_151,
  PLAN_CN_CD_TIANFUHEMING_130,
  PLAN_CN_HZ_WEIKECHENMINGFU_132,
  PLAN_CN_NJ_JINYUZIJINGFU_130,
  PLAN_CN_WH_ZHAOSHANGTIANQINGFU_130,
  PLAN_CN_WH_JINRONGJIEJINYUEFU_130,
  PLAN_CN_SH_WEIFANGER_1BR0_36,
  PLAN_CN_SH_WEIFANGER_2BR0_44,
  PLAN_CN_GZ_BAOLITIANYUE_251,
];
