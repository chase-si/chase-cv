...
/** Upwork brand mark (Simple Icons). Brand green so the “Up” mark reads as the logo. */
export function UpworkIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      {/* Official Upwork green — brand mark, not a theme token */}
      <path
        fill="#6FDA44"
