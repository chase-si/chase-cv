...
function ProjectPreviewArt({ id }: { id: ProjectId }) {
    ...
    return (
      <div aria-hidden className="flex h-full min-h-56 flex-col justify-between overflow-hidden bg-muted/20 p-4 sm:p-5">
        <div className="flex items-center gap-4">
          <div className="flex size-16 shrink-0 items-center justify-center rounded-xl border-2 border-border bg-card text-muted-foreground shadow-[3px_3px_0_0] shadow-foreground/50 sm:size-20">
            <ImageIcon className="size-7 sm:size-8" />
          </div>
          <span className="shrink-0 text-3xl font-black sm:text-4xl">→</span>
          <div className="flex min-w-0 rounded-xl border-2 border-border bg-card p-1 shadow-[3px_3px_0_0] shadow-foreground/50">
        ...
        <div className="grid grid-cols-2 gap-3 rounded-2xl border-2 border-border bg-card p-4 shadow-xs">
  ...
  return (
    ...
    >
      <div className="absolute left-4 top-4 flex flex-col gap-2 rounded-xl border-2 border-border bg-card p-2 shadow-[3px_3px_0_0] shadow-foreground/50">
        {["↖", "○", "□", "T"].map((tool) => (
      ...
      <div className="ml-8 flex flex-col items-center gap-3 sm:ml-0">
        <span className="rounded-xl border-2 border-border bg-chart-2/70 px-5 py-2 text-xs font-bold shadow-[3px_3px_0_0] shadow-foreground/50">
          Start
        </span>
        <span className="h-8 w-px bg-border" />
        <span className="rounded-xl border-2 border-border bg-primary px-5 py-2 text-xs font-bold text-primary-foreground shadow-[3px_3px_0_0] shadow-foreground/50">
          Check
        </span>
        <div className="grid grid-cols-2 gap-4 sm:gap-10">
          <span className="rounded-xl border-2 border-border bg-card px-5 py-2 text-xs font-bold shadow-[3px_3px_0_0] shadow-foreground/50">
            Action A
          </span>
          <span className="rounded-xl border-2 border-border bg-card px-5 py-2 text-xs font-bold shadow-[3px_3px_0_0] shadow-foreground/50">
            Action B
      ...
      <div className="absolute bottom-5 right-4 hidden w-28 rounded-xl border-2 border-border bg-card p-3 font-mono text-[10px] shadow-[3px_3px_0_0] shadow-foreground/50 sm:block">
                ...
                <div className="grid gap-0 lg:grid-cols-[minmax(0,0.86fr)_minmax(0,1fr)]">
                  ...
                  <div className="flex flex-col gap-5 p-6 sm:p-8">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Badge variant="outline" className="rounded-md border-border font-mono shadow-[2px_2px_0_0] shadow-foreground/50">
                    ...
                    <div className="mt-auto pt-2">
                      <Button
                        ...
                        nativeButton={false}
                        className="min-w-32 rounded-xl shadow-xs"
                      >
